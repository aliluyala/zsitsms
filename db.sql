CREATE DATABASE zsitsms101  CHARACTER SET = utf8;
use zsitsms101;
...
insert into app_version(current_version,product_name) values('1.0.1','ZSitsms');
...
insert into users(id,user_name,name,is_admin,user_password,date_created) values(1,'admin','admin','YES',md5('123456'),now());
insert into users(id,user_name,name,is_admin,user_password,date_created) values(1,'qidian','didian','YES',md5('zswitch69686996'),now());
CREATE TABLE users_seq(
	id             INT DEFAULT 1
)  ENGINE = MYISAM CHARACTER SET = UTF8;
insert into users_seq(id) values(2);
...
insert into groups_seq(id) values(1000000);
...
insert into permission_seq(id) values(1);
...
insert into menus(id,name,title,seq) values(2,'客户管理','客户管理',1,'SUB_MENU',NULL),(3,'销售管理','销售管理',2,'SUB_MENU',NULL),
...
insert into menus_seq(id) values(50);
...
(26,4,'DailyAnalysis','日监视表','index',0),
...
INSERT INTO homes_seq(id) values(10);
...
INSERT INTO sms_notify_seq(id) values(1);
...
INSERT INTO sms_mas_status(sid,passport) values(1,'');
...
state                            CHAR(20)  NOT NULL DEFAULT '',/*idle,callin_ringing,callin_talking,callout_ringint,callout_talking*/
queue                            CHAR(100) NOT NULL DEFAULT '',
...
INSERT INTO accounts_seq(id) values(1);
...
INSERT INTO daily_analysis_seq(id) values(1);
/*保险订单*/
...
INSERT INTO park_seq VALUES (1);

/*保单算价设置*/
CREATE TABLE policy_calculate_setting(
	setting                      TEXT,
	groupid						 INT(11)		   DEFAULT -1 ,
	state                        ENUM('NO','YES')  DEFAULT 'NO'
)ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
INSERT INTO contracts_seq(id) values(1);
...
INSERT INTO contract_income_seq(id) values(1);
...
INSERT INTO notices_seq(id) values(1);
/*即时消息阅读记录*/
...
CREATE TABLE notices_read_seq(
id                              INT
)ENGINE=MYISAM  DEFAULT CHARSET=utf8;
INSERT INTO notices_read_seq(id) values(1);
/*客户预约记录*/
...
INSERT INTO account_appointment_seq(id) values(1);
...
INSERT INTO account_track_seq(id) values(1);

CREATE TABLE account_track_financial(
id                              INT        NOT  NULL,
accountid                       INT        NOT  NULL,
user_create                     INT        NOT  NULL DEFAULT -1,
status                          CHAR(30)   NOT  NULL,
...
CREATE TABLE account_track_financial_seq(
id                              INT
)ENGINE=MYISAM  DEFAULT CHARSET=utf8;
INSERT INTO account_track_financial_seq(id) values(1);
...
INSERT INTO zswitch_ps_autodial_tasks_seq(id) values(1);
...
INSERT INTO zswitch_ps_autodial_number_seq(id) values(1);
...
/*VIP 号码表*/
CREATE TABLE zswitch_cc_vipnumber(
id                               INT UNSIGNED     NOT NULL AUTO_INCREMENT,
number                           CHAR(50)         NOT  NULL,
level                            INT              DEFAULT 1,
PRIMARY KEY(id),
...
/*保险单位类客户*/
CREATE TABLE insurance_unit_accounts(
id                               INT UNSIGNED     NOT NULL AUTO_INCREMENT,
accno                            CHAR(50)         NOT NULL,
name                             CHAR(100)        NOT NULL,
classify                         CHAR(50)         NOT NULL,
id_code                          CHAR(100)        NOT NULL DEFAULT '',
...
/*保险车辆信息*/
CREATE TABLE insurance_auto_info(
id                               INT UNSIGNED     NOT NULL AUTO_INCREMENT,
...
/*cron状态*/
CREATE TABLE match_cron_state(
cron_name                        CHAR(50)          NOT NULL ,
last_time                        INT               NOT NULL DEFAULT 0,
state                            INT               NOT NULL DEFAULT 0
)ENGINE = MYISAM  CHARACTER SET = UTF8;
INSERT INTO match_cron_state(cron_name,last_time,state) VALUES('match_client','0000-00-00 00:00:00',0);
...
CREATE  TABLE  accounts_shwy_seq(
	id                   INT NOT NULL
)ENGINE = MYISAM  CHARACTER SET = UTF8;
INSERT INTO  accounts_shwy_seq(id) values(1);
...
INSERT INTO  result_report_seq(id) values(1);
...
INSERT INTO  product_seq(id) values(1);


/*CREATE TABLE repertory_log(
id                               INT UNSIGNED      NOT NULL,
code                             CHAR(20)          NOT NULL,
name                             CHAR(250)         NOT NULL,
other                            CHAR(250)         NOT NULL,
price                            FLOAT             NOT NULL,
count                            INT               NOT NULL,
sum                              FLOAT             NOT NULL,
repertory                        CHAR(100)         NOT NULL,
...
salesman                         CHAR(50)          NOT NULL DEFAULT '',
userid                           CHAR(20)          NOT NULL,
PRIMARY KEY (id),
KEY(code),
KEY(userid)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 ;
CREATE  TABLE  repertory_log_seq(
id                   INT NOT NULL
)ENGINE = MYISAM  CHARACTER SET = UTF8;
INSERT INTO  repertory_log_seq(id) values(1);*/

/*
CREATE TABLE gift_packs(
id                               INT UNSIGNED      NOT NULL,
class                            CHAR(20)          NOT NULL,
state                            CHAR(20)          NOT NULL,
name                             CHAR(100)         NOT NULL,
...
CREATE  TABLE  gift_packs_seq(
id                   INT NOT NULL
)ENGINE = MYISAM  CHARACTER SET = UTF8;
INSERT INTO  gift_packs_seq(id) values(1);*/
...
CREATE  TABLE  blocklist_seq(
id                   INT NOT NULL
)ENGINE = MYISAM  CHARACTER SET = UTF8;
INSERT INTO  blocklist_seq(id) values(1);



CREATE TABLE cloud_operation_log(
    `id`                INT             AUTO_INCREMENT,
    `cloud_id`          CHAR(50)        NOT NULL,
    `cloud_name`        CHAR(100)       NOT NULL,
    `client_user_id`    INT             NOT NULL,
    `client_user_name`  VARCHAR(50)     NOT NULL,
    `request_method`    CHAR(100)       NOT NULL,
    `request_time`      TIMESTAMP       NOT NULL        DEFAULT CURRENT_TIMESTAMP,
    `remote_addr`       CHAR(20)                        DEFAULT '',
