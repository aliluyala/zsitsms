...
class BGAI_INS 
{
	 ...
	 * 版本
	 **/
	public         $Version = 'BLDDPSX-2009(A)-YN-PICCP&C';	
	/**
	 * 主险代码
	 **/
	...
	private	      $Rate = array(
				  	'NON_OPERATING_PRIVATE' => array(
						array(0,5,'DOMESTIC',0.0018),
						array(0,5,'IMPORTED',0.0030),
						
						array(6,9,'DOMESTIC',0.0018),
						array(6,9,'IMPORTED',0.0030),
						
						array(10,0xffff,'DOMESTIC',0.0022),
						array(10,0xffff,'IMPORTED',0.0035),
				  	),  
				  	'NON_OPERATING_ENTERPRISE' => array(
						array(0,5,'DOMESTIC',0.0013),
						array(0,5,'IMPORTED',0.0023),
						
						array(6,9,'DOMESTIC',0.0013),
						array(6,9,'IMPORTED',0.0023),
						
						array(10,19,'DOMESTIC',0.0014),
						array(10,19,'IMPORTED',0.0026),
						
						array(20,0xffff,'DOMESTIC',0.0015),
						array(20,0xffff,'IMPORTED',0.0028),
				  	),  	
				  	...
				  	'OPERATING_LEASE_RENTAL' => array(
						...
						array(10,19,'IMPORTED',0.0035),
						
						array(20,35,'DOMESTIC',0.0025),
						array(20,35,'IMPORTED',0.0042),
						
						array(36,0xffff,'DOMESTIC',0.0027),
				  	...
				  	'OPERATING_CITY_BUS' => array(								
						...
						array(20,35,'DOMESTIC',0.0024),
						array(20,35,'IMPORTED',0.0041),
						
						array(36,0xffff,'DOMESTIC',0.0026),
						array(36,0xffff,'IMPORTED',0.0045),
				  	),  
				  	...
				  	'NON_OPERATING_TRUCK' => array(								
						...
						array(0,1.9999,'IMPORTED',0.0016),
				  	...
				  	'OPERATING_TRUCK' => array(								
				  		array(0,1.9999,'DOMESTIC',0.0012),
						array(0,1.9999,'IMPORTED',0.0018),
						
						array(2,4.9999,'DOMESTIC',0.0012),
						array(2,4.9999,'IMPORTED',0.0018),
						
						array(5,9.9999,'DOMESTIC',0.0012),
						array(5,9.9999,'IMPORTED',0.0018),
						
						array(10,0xffff,'DOMESTIC',0.0012),
						array(10,0xffff,'IMPORTED',0.0018),
				  	),  
					
				  	'SPECIAL_AUTO' => array(								
				  		array(1,1,'DOMESTIC',0.0007),
						array(1,1,'IMPORTED',0.0014),
						
				  		array(2,2,'DOMESTIC',0.0008),
						array(2,2,'IMPORTED',0.0015),
						
				  		array(3,3,'DOMESTIC',0.0008),
						array(3,3,'IMPORTED',0.0016),
						
						array(4,4,'DOMESTIC',0.0009),
						array(4,4,'IMPORTED',0.0017),
