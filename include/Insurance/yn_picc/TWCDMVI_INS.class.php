...
class TWCDMVI_INS 
{
	 ...
	 * 版本
	 **/
	public         $Version = 'QCDQX-2009(A)-YN-PICCP&C';	
	/**
	 * 主险代码
	 **/
	...
	private	      $Rate = array(
				  	'NON_OPERATING_PRIVATE' => array(
				  		...
				  		array(6,9,140,0.0048),
						array(10,0xffff,140,0.0048),
				  	),  
				  	'NON_OPERATING_ENTERPRISE' => array(
				  		array(0,5,120,0.0039),
				  		array(6,9,130,0.0056),
				  		array(10,19,130,0.0056),
						array(20,0xffff,140,0.0054),
				  	),  	
				  	'NON_OPERATING_AUTHORITY' => array(
				  		array(0,5,110,0.0033),
						array(6,9,120,0.0049),
						array(10,19,120,0.0049),
						array(20,0xffff,130,0.0048),
