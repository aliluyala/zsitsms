...
class TCPLI_INS 
{
	 ...
	 * 版本
	 **/
	public         $Version = 'CSRYZRX-2008(A)-JS-PICCP&C';	
	/**
	 * 主险代码
	 **/
	...
	private	      $Rate = array(
				  	...
				  	'OPERATING_LEASE_RENTAL' => array(
				  		...
				  		array(10,19,0.0042,0.0025),
				  		array(20,35,0.0042,0.0025),
						array(36,0xffff,0.0042,0.0025),
				  	), 
				  	'OPERATING_CITY_BUS' => array(								
				  		array(6,9,0.0041,0.0025),
				  		array(10,19,0.0043,0.0026),
				  		array(20,35,0.0049,0.003),
						array(36,0xffff,0.0049,0.003),
				  	),  
				  	...
				  	'OPERATING_TRUCK' => array(								
				  		array(0,1.9999,0.0072,0.0046),
						array(2,4.9999,0.0072,0.0046),
						array(5,9.9999,0.0072,0.0046),
						array(10,0xffff,0.0072,0.0046),
				  	),  
				  	'SPECIAL_AUTO' => array(								
				  		array(1,1,0.0054,0.0036),
				  		array(2,2,0.0054,0.0036),
				  		array(3,3,0.0054,0.0036),
						array(4,4,0.0054,0.0036),
				  	),	
				  	'MOTORCYCLE' => array(								
