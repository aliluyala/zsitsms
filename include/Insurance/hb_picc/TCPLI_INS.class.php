...
class TCPLI_INS 
{
	 ...
	 * 版本
	 **/
	public         $Version = 'CSRYZRX-2008(A)-HB-PICCP&C';	
	/**
	 * 主险代码
	 **/
	...
	private	      $Rate = array(
				  	'NON_OPERATING_PRIVATE' => array(
				  		...
				  		array(6,9,0.0038,0.0025),
						array(10,0xffff,0.0038,0.0025),
				  	),  
				  	'NON_OPERATING_ENTERPRISE' => array(
				  		array(0,5,0.0042,0.0026),
				  		array(6,9,0.0039,0.0023),
				  		array(10,19,0.0039,0.0023),
						array(20,0xffff,0.0041,0.0025),
				  	),  	
				  	'NON_OPERATING_AUTHORITY' => array(
				  		array(0,5,0.004,0.0025),
						array(6,9,0.0037,0.0022),
						array(10,19,0.0038,0.0023),
						array(20,0xffff,0.0039,0.0024),
				  	...
				  	'NON_OPERATING_TRUCK' => array(								
				  		array(0,1.9999,0.0047,0.0029),
						array(2,4.9999,0.0049,0.0029),
						array(5,9.9999,0.0049,0.0029),
						array(10,0xffff,0.0049,0.0029),
				  	),
				  	...
				  	'SPECIAL_AUTO' => array(								
				  		array(1,1,0.0062,0.0041),
				  		array(2,2,0.0062,0.0041),
				  		array(3,3,0.0062,0.0041),
						array(4,4,0.0062,0.0041),
				  	),	
				  	'MOTORCYCLE' => array(								
