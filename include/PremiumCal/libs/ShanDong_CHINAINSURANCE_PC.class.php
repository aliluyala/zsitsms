...
class ShanDong_CHINAINSURANCE_PC
{
...
//（号牌类型）     01 大型 02小型 03使馆04领馆 05境外 06外籍 07两，三轮摩托车 08轻便 09使馆摩托车 10领馆摩托车 11境外摩托车 12 外籍摩托车 13 农用运输车 14拖拉机 15 挂车 16 教练汽车  17教练摩托车 18试验汽车 19试验摩托车 20临时入境汽车 21临时入境摩托车 22临时行驶车 80警用汽车 81 警用摩托车 82 公安民用 83 武警 84 军队
	...
	{		
			   ...
			   if($app['RESULT_TYPE']=="ERROR")
			   {
				...
				if(!empty($mvtalci))
				{
                 ...
                 /*******************商业险********************/
                                 $results['MESSAGE']  = $app['RESULT_MSG'];  //商业险投保信息
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036001")//车损险
											   			{
											   					...
											   					$results['BUSINESS']['BUSINESS_ITEMS']['TVDI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   					$results['BUSINESS']['BUSINESS_ITEMS']['TVDI_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
											   			}
		                                  				break;
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036002")//三者险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['TTBLI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['TTBLI_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
											   			}
		                                  				break;
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036003")//司机险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['TCPLI_DRIVER']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['TCPLI_DRIVER_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
											   			}
		                                  				break;
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036004")//乘客险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['TCPLI_PASSENGER']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['TCPLI_PASSENGER_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
											   			}
		                                  				break;
		                                  			case 'TWCDMVI':
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036005")//盗抢险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['TWCDMVI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['TWCDMVI_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
											   			}
		                                  				break;
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036006")//玻璃险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['BGAI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036007")//自燃险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['SLOI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['SLOI_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036008")//新增险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['NIELI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['NIELI_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
											   			}
		                                  				break;
		                                  			case 'RDCCI':
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036009")//补偿险
											   			{
											   				$Cvrg_NPerPrm+=$v['attributeVoList']['Cvrg.NPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['RDCCI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   			}
		                                  				break;
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036012")//涉水险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['VWTLI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['VWTLI_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
											   			}
		                                  				break;	
		                                  			case 'BSDI':
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036013")//车身划痕险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['BSDI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
											   				$results['BUSINESS']['BUSINESS_ITEMS']['BSDI_NDSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrmShortDuct']['value'];
											   			}
		                                  				break;
		                                  			case 'STSFS':
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036022")//指定专修厂
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['STSFS']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
		                                  				...
		                                  				if($v['attributeVoList']['Cvrg.CCvrgNo']['value']=="036024")//第三方特约险
											   			{
											   				...
											   				$results['BUSINESS']['BUSINESS_ITEMS']['MVLINFTPSI']['PREMIUM']=$v['attributeVoList']['Cvrg.NPerPrm']['value'];
	...
	public function queryBuyingPrice($info=array())
	{
			...
			$vin_where.="vname=&";
			$vin_where.="searchVin=".$info['vin_no']."&";
			$vin_where.="vinflag=1&";
			...
			$string = $this->requestPostData($this->modelrice."?".http_build_query($where),$datas);
			...
			if(strpos($string, "没有找到符合条件的数据"))
			{
					...
					$vin_where.="vinflag=1&";
					$vin_where.="validNo=653eb5cdac40e71bf0d954b2e0fe3eef";
					$string= iconv("GBK", "UTF-8", $this->requestGetData($this->search."?".$vin_where));
					preg_match_all("/<table id=\"zhcx\".*>(.*)<\/table>/Us",$string,$result);
