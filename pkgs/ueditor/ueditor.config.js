...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,scrawlPath:URL+"uploads/"                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"php/fileUp.php"               //附件上传提交地址
        ,filePath:URL + "uploads/"                   //附件修正地址，同imagePath
...
//        }
        ...
        ,initialFrameWidth:970  //初始化编辑器宽度,默认1000
