...
<div class="client_listview_bar small">
	<table border="0" cellspacing="0"  width="100%">
		<tr>
			...
			{/if}
			{if $LISTVIEW_BUTTONS.recycle }
				<button class="client_listview_button small" title="批量恢复" action="batch_recycle">批量恢复</button>
			{/if}
			</td>
...
<script type="text/javascript" >
	...
	{literal}
		...
		$(".client_listview_button").button().click(function(){
			...
			else if(oper == 'batch_recycle')
			{
				account.zswitch_listview_batch_recycle_dlg(listModuleName);
			}
		});
	{/literal}
</script>
