...
<table border="0px" style="width:100%;font-size:12px;vertical-align:top;">
	<tr>
		...
		{/if}
		{if $DETAILVIEW_BUTTONS.recycle}
			<button  style="width:100px;padding-bottom:2px;" class="client_detailview_operation_button small" title="恢复"   action="recycle">恢复</button><br/>
		{/if}
...
<script type="text/javascript">
	...
	$(".client_detailview_operation_button").button().click(function(){
		...
		{
			account.zswitch_listview_operation_recycle(module,recordid);
		}
