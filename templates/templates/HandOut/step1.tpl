                ...
                <div style="padding:1px;">
                    <table class="client_detailview_table" cellspacing="0">
                        <tr>
                            ...
                            <td class="client_detailview_value_3">
                                {include file="UI/{$OPERATION_TEAM_FIELD.UI}.UI.tpl" FIELDINFO=$OPERATION_TEAM_FIELD}
                            </td>
                        </tr>
                        <tr>
                            <td class="client_detailview_label_3">
                            ...
                            <td class="client_detailview_value_3">
                                {include file="UI/{$OPERATION_MODEL_FIELD.UI}.UI.tpl" FIELDINFO=$OPERATION_MODEL_FIELD}
                            </td>
                        </tr>
                        <tr>
                            <td class="client_detailview_label_3">
                            ...
                            <td class="client_detailview_value_3">
                                {include file="UI/{$OPERATION_COMPANY_FIELD.UI}.UI.tpl" FIELDINFO=$OPERATION_COMPANY_FIELD}
                            </td>
                            <td class="client_detailview_label_3">
                        ...
                        <tr>
                            ...
                            <td class="client_detailview_value_3">
                                {include file="UI/{$OPERATION_EXPIRATION_DATE_FIELD.UI}.UI.tpl" FIELDINFO=$OPERATION_EXPIRATION_DATE_FIELD}
                            </td>
                            <td class="client_detailview_label_3">
                            ...
                            <td class="client_detailview_value_3">
                                {include file="UI/{$OPERATION_EXPIRATION_DATE_END_FIELD.UI}.UI.tpl" FIELDINFO=$OPERATION_EXPIRATION_DATE_END_FIELD}
                            </td>
                        </tr>
                        <tr>
                            <td class="client_detailview_label_3">
