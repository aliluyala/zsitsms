...
<tr><td>
	...
	<tbody>
		...
		<tr>
			...
			<td class="formfieldcontent" style=" border: 1px solid #dcdcdc; ">{$form.SEATS}<button id="policy_calculate_check_btn">交管车辆查询</button></td>
		...
		<tr>
			...
			<td class="formlabel" style="display:none;">行业车型代码</td>
			<td class="formfieldcontent" style="display:none;">{$form.INDUSTY_CODE}</td>
		</tr>
...
<tr><td>
	...
	<!--	<td style="border: 1px solid #dcdcdc; " >{$form.RDCCI_DISCOUNT_PREMIUM}</td> -->
			<td style="border: 1px solid #dcdcdc; " ><!--<input id="form[BUSINESS_ITEMS][RDCCI_NDSI]" type="checkbox" name="form[BUSINESS_ITEMS][]" value="RDCCI_NDSI" />--></td>
			<td style="border: 1px solid #dcdcdc; " ><!--{$form.RDCCI_NDSI_PREMIUM}--></td>
		</tr>
	...
	<!--	<td style="border: 1px solid #dcdcdc; " >{$form.MVLINFTPSI_DISCOUNT_PREMIUM}</td> -->
			<td style="border: 1px solid #dcdcdc; " ><!--<input id="form[BUSINESS_ITEMS][MVLINFTPSI_NDSI]" type="checkbox" name="form[BUSINESS_ITEMS][]" value="MVLINFTPSI_NDSI" />--></td>
			<td style="border: 1px solid #dcdcdc; " ><!--{$form.MVLINFTPSI_NDSI_PREMIUM}--></td>
		</tr>
