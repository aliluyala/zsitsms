...
<div class="client_listview_bar small">
	<table border="0" cellspacing="0"  width="100%">
		<tr>
			...
			{if $LISTVIEW_BUTTONS.real_status }
				<button class="client_listview_button small" title="实时状态" action="real_status">实时状态</button>
			{/if}	
...
<script type="text/javascript" >
	...
	{literal}
		...
		$(".client_listview_button").button().click(function(){
			...
			if(oper == 'real_status')
			{
				zswitch_load_client_view("index.php?module=ListMatch&action=realStatus");
			}
