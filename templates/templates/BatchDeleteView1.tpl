...
<div style="margin-top:5px;">
<span style="margin-left:10px;line-height:20px;font-weight:bold;">
	<label for='delete_associateby_record' title="强制删除被其它关联的记录">强制删除被关联记录：</label>
</span>
<input id="delete_associateby_record" type="checkbox" name="delete_associateby_record" value="YES" />
</div>
