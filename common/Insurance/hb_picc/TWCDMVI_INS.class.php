...
class TWCDMVI_INS 
{
	 ...
	 * 版本
	 **/
	public         $Version = 'QCDQX-2008(A)-HB-PICCP&C';	
	/**
	 * 主险代码
	 **/
	...
	private	      $Rate = array(
				  	'NON_OPERATING_PRIVATE' => array(
				  		array(0,5,120,0.0042),
				  		array(6,9,140,0.0039),
						array(10,0xffff,140,0.0039),
				  	),  
				  	'NON_OPERATING_ENTERPRISE' => array(
				  		array(0,5,120,0.0045),
				  		array(6,9,130,0.0045),
				  		array(10,19,130,0.0045),
						array(20,0xffff,140,0.0044),
				  	),  	
				  	'NON_OPERATING_AUTHORITY' => array(
				  		array(0,5,110,0.0042),
						array(6,9,120,0.0046),
						array(10,19,120,0.0043),
						array(20,0xffff,130,0.0041),
				  	...
				  	'OPERATING_LEASE_RENTAL' => array(
				  		...
				  		array(20,35,80,0.0046),
						array(36,0xffff,80,0.0046),
				  	), 
				  	'OPERATING_CITY_BUS' => array(								
				  		array(6,9,60,0.0046),
				  		array(10,19,90,0.0045),
				  		array(20,35,90,0.0045),
						array(36,0xffff,90,0.0045),
				  	),  
				  	'OPERATING_HIGHWAY_BUS' => array(								
				  		array(6,9,60,0.0047),
						array(10,19,90,0.0045),
						array(20,35,80,0.0041),
						array(36,0xffff,80,0.0045),
