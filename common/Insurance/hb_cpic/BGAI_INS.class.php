...
class BGAI_INS 
{
	 ...
	 * 版本
	 **/
	public         $Version = 'BLDDPSX-2009(c)-HB-CPIC';	
	/**
	 * 主险代码
	 **/
	...
	private	      $Rate = array(
				  	...
				  	'NON_OPERATING_AUTHORITY' => array(
						...
						array(6,9,'DOMESTIC',0.0014),
						array(6,9,'IMPORTED',0.0024),
						
						array(10,19,'DOMESTIC',0.0015),
						array(10,19,'IMPORTED',0.0028),
						
						array(20,35,'DOMESTIC',0.0017),
						array(20,35,'IMPORTED',0.0029),
						
						array(36,0xffff,'DOMESTIC',0.0017),
						array(36,0xffff,'IMPORTED',0.0029),
				  	),  
				  	...
				  	'OPERATING_CITY_BUS' => array(								
						...
						array(36,0xffff,'IMPORTED',0.0049),
				  	),  
				  	'OPERATING_HIGHWAY_BUS' => array(								
						array(6,9,'DOMESTIC',0.0020),
						array(6,9,'IMPORTED',0.0032),
						
						array(10,19,'DOMESTIC',0.0022),
						array(10,19,'IMPORTED',0.0037),
				  	...
				  	'SPECIAL_AUTO' => array(								
						...
						array(3,3,'IMPORTED',0.0017),
						
						array(4,4,'DOMESTIC',0.0009),
						array(4,4,'IMPORTED',0.0018),
