<?php
$bar_buttons = createListViewButtons(Array('delete','modify'));
$tpl_file = "LibraryPost/ListView.tpl";
...
global $focus;
if(!isset($focus) && is_file(_ROOT_DIR."/modules/LibraryCategory/LibraryCategoryModule.class.php"))
{
    require_once(_ROOT_DIR."/modules/LibraryCategory/LibraryCategoryModule.class.php");
    $modclass= "LibraryCategoryModule";
    $focus = new $modclass();
}
...
$smarty->assign('POST_CATEGORY',$focus->getCategoryList());
