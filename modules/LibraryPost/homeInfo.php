...
global $mod;
if(!class_exists('LibraryPostModule'))
{
	require(_ROOT_DIR."/modules/LibraryPost/LibraryPostModule.class.php");
	$mod = new LibraryPostModule();
}
...
if($result)
{
	...
	$list_data = formatListDatas($result,'LibraryPost','id',$mod->fields,$listFields,'title',$mod->picklist,Array());
}
