<?php
class ExpressModule extends BaseModule
{
	public $baseTable = 'express';
	//模块描述
	public $describe = '快递公司';
	//需要控制访问权限的模块方法
	...
	//分栏定义
	public $blocks = Array('LBL_EXPRESS_BASE'   => Array('1',true,Array('name')),
						   'LBL_EXPRESS_REMARK' => Array('1',true,Array('description')),
						   'LBL_EXPRESS_ADDR'   => Array('1',true,Array('user_attach')),
						);
	//枚举字段值
