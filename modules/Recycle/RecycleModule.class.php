<?php
class RecycleModule extends BaseModule
{
	...
	public $picklist = Array(
		...
		'distribute_option' => Array('HANDOUT','HANDOUT_DELETE','HANDOUT_RECYCLE','BATCH_MODIFY','BATCH_DELETE','MODIFY','DELETE','RECYCLE','BATCH_RECYCLE'),
	);
