<?php
class CourierModule extends BaseModule
{
	public $baseTable = 'courier';
	//模块描述
	public $describe = '快递人员';
	//需要控制访问权限的模块方法
	...
	public $fields = array(
			'name'            => array('5','S',true,'姓名'),
			'express'	      => array('50','N',true,'公司',0),
	...
	//分栏定义
	public $blocks = Array('LBL_COURIER_BASE'   => Array('1',true,Array('name','express','mobile')),
						   'LBL_COURIER_REMARK' => Array('1',true,Array('description')),
						   'LBL_COURIER_ADDR'   => Array('1',true,Array('user_attach')),
						);
	//枚举字段值
