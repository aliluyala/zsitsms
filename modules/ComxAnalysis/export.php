...
/* 去掉导出不需要的字段 */
$export_fields = array_slice($mod->fields,4);
//array_splice($mod->fields, 0, 4);//此方式为直接去掉，会影响查询条件
/* 去掉导出不需要的字段 */
$step = '1';
