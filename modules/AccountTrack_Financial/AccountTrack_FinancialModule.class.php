<?php
class AccountTrack_FinancialModule extends BaseModule
{
	public $baseTable = 'account_track_financial';
	//模块描述
	public $describe = '客户跟踪记录';
	//需要控制访问权限的模块方法
	...
	public $picklist = Array(
		...
		'status'			=> array('APPOINTMENT_QUOTATION','APPOINTMENT_NON_QUOTATION','FAILED','INVALID','SUCCESS'),
	...
	public $associateTo = Array(
		...
		'accountid' => Array('MODULE','Accounts','detailView','id','owner'),
	);
	//模块关联
